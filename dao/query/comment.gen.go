...
func newComment(db *gorm.DB, opts ...gen.DOOption) comment {
	...
	_comment.CreatedAt = field.NewInt32(tableName, "created_at")
	_comment.UpdatedAt = field.NewInt32(tableName, "updated_at")
...
func (c *comment) updateTableName(table string) *comment {
	...
	c.CreatedAt = field.NewInt32(table, "created_at")
	c.UpdatedAt = field.NewInt32(table, "updated_at")
